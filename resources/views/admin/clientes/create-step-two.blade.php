...
<div class="col-md-4 col-xs-4">
  ...
  <div class="col-md-4 col-xs-4">
    <div class="form-group">
      ...
      <input type="text" name="honorario_inicial" value="{{ $cliente->honorario_inicial ?? '' }}" placeholder="Honorários Iniciais R$ e Por Extenso:" data-parsley-required="false" class="form-control" />
    </div>
  </div>
  ...
  <div class="col-md-4 col-xs-4">
    <div class="form-group">
      <label for="forma_pagamento">Detalhamento da Forma de Pagamento</label>
          <input type="text" name="forma_pagamento" value="{{ $cliente->forma_pagamento ?? '' }}" placeholder="Forma de Pagamento" data-parsley-required="true" class="form-control" />
    </div>
  </div>
  <div class="col-md-4 col-xs-4">
    <div class="form-group">
  ...
  <div class="col-md-4 col-xs-4">
    <div class="form-group">
      <label for="forma_captacao">Forma de Captação:</label>
      <select class="form-control" id="forma_captacao" data-size="5" data-live-search="true" data-width="100%" name="forma_captacao" required>
        {{-- <option value="{{ $cliente->forma_captacao ?? '' }}" selected="selected"> {{ $cliente->forma_captacao ?? 'Selecione uma opção' }} </option> --}}
