...
@section('content')
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Adicionar um novo Cliente <small>Informe todos os campos com (*) será importante para geração dos documentos!</small></h1>
	<!-- end page-header -->
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form action="{{ route('clientes.create.step.one.post') }}" method="POST" name="form-wizard" class="form-control-with-bg">
                @csrf
...
<div class="row">
  ...
  <div class="col-md-3 col-xs-3">
	...
	<div class="col-md-3 col-xs-3">
		...
		<input type="text" id="masked-input-phone" name="celular" value="{{ $cliente->celular ?? '' }}" placeholder="Celular" data-parsley-group="step-1" data-parsley-required="true" class="form-control" required />
